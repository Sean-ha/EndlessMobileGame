...
public class CameraShake : MonoBehaviour
{
    ...
    // duration should be 0.5f for normal circumstances, or 1.2f for major shake (e.g. on boss kill)
        ...
        while (counter < duration)
        {
            ...
            if (counter >= decreasePoint)
            {
                ...
                while (counter <= decreasePoint)
                {
                    ...
                    cam.rotation = defaultRot * Quaternion.AngleAxis(UnityEngine.Random.Range(-decreaseAngle, decreaseAngle), new Vector3(0f, 0f, 1f));
